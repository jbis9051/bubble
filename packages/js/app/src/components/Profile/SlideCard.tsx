...
const ChildrenComponent = (
    <View>
        ...
        <View style={{
            ...
            <InfoCard title='Email' detail='johnappleseed@bubble.com' icon={mailIcon} />
            <InfoCard title='Phone' detail='123-456-7890' icon={phoneIcon} />
            <InfoCard title='Username' detail='johnappleseed' icon={userIcon} />
            <InfoCard title='Last seen' detail='San Franscico, California' icon={locationIcon} />
        </View>
    </View>
);
...
const SlideCard = () => (
    <SlideCardTemplate children={ChildrenComponent} />
);
